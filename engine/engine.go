...
func (e *Engine) Start() error {
...

	{
		...
		// //获取交易所
		// exchCfg, _ := e.Config.GetExchangeConfig("Huobi")
		...
		// 查看帐号和持仓信息
		// var req = huobi.SymbolBaseType{
		// 	Symbol: "BTC",
		// }
		// accountPositionInfoData, err := huobiExch.GetContractAccountPositionInfo(req)
		// if err != nil {
		// 	panic(err)
		// }
		...
		// 	}
		// }
		// // fmt.Println(accountPositionInfo)
		// return nil
		...
		// }
		// contractInfo, err := huobiExch.GetContractInfo(req)
		// if err != nil {
		// 	panic(err)
		// } else {
		...
		// 获取火币季度合约K线
		// req := huobi.KlinesRequestParams{
		// 	Symbol: "BTC_CQ",
		// 	Period: huobi.TimeIntervalFiveMinutes,
		// 	Size:   10,
		// }
		// list, err := huobiExch.GetContractKline(req)
		// if err != nil {
		// 	panic(err)
		// } else {
		// 	for _, v := range list {
		// 		fmt.Println("Close:", v.Close, convert.UnixTimestampToTime(v.ID).Format(_timeFormat_local), v)
		// 	}
